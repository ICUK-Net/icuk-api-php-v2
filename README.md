...
------------ | ------------- | ------------- | -------------
*AdminWebhooksApi* | [**webhooksPingGet**](docs/Api/AdminWebhooksApi.md#webhookspingget) | **GET** /webhooks/ping | Test request
*AdminWebhooksApi* | [**webhooksSimwoodPortPost**](docs/Api/AdminWebhooksApi.md#webhookssimwoodportpost) | **POST** /webhooks/simwood/port | Process Simwood port update
...
*BroadbandAvailabilityApi* | [**broadbandAvailabilityInputGet**](docs/Api/BroadbandAvailabilityApi.md#broadbandavailabilityinputget) | **GET** /broadband/availability/{input} | Search for your phone number, access line ID or postcode and return a list of  available broadband products with the speeds available.
...
*BroadbandAvailabilityApi* | [**broadbandAvailabilityUprnInputGet**](docs/Api/BroadbandAvailabilityApi.md#broadbandavailabilityuprninputget) | **GET** /broadband/availability/uprn/{input} | Search with a UPRN and return a list of available broadband products with the speeds available.
...
*BroadbandIPApi* | [**broadbandIpRoutedDeleteUsernamePost**](docs/Api/BroadbandIPApi.md#broadbandiprouteddeleteusernamepost) | **POST** /broadband/ip/routed/delete/{username} | Removes a routed subnet from a broadband user
*BroadbandIPApi* | [**broadbandIpRoutedUsernameDelete**](docs/Api/BroadbandIPApi.md#broadbandiproutedusernamedelete) | **DELETE** /broadband/ip/routed/{username} | Removes a routed subnet from a broadband user [DEPRECATED]
...
*BroadbandSpeedtestApi* | [**broadbandSpeedtestUsernameGet**](docs/Api/BroadbandSpeedtestApi.md#broadbandspeedtestusernameget) | **GET** /broadband/speedtest/{username} | Get the speed test history for the specified user
...
*BroadbandTroubleshootingApi* | [**broadbandDlmResetPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbanddlmresetput) | **PUT** /broadband/dlm/reset | Perform a DLM reset on a connection
*BroadbandTroubleshootingApi* | [**broadbandDlmResetResultsUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbanddlmresetresultsusernameget) | **GET** /broadband/dlm/reset/results/{username} | Obtain results from the DLM reset tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandDlmResetResultsUsernameIdGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbanddlmresetresultsusernameidget) | **GET** /broadband/dlm/reset/results/{username}/{id} | Obtain results from the DLM reset tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandInterleavingCurrentUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandinterleavingcurrentusernameget) | **GET** /broadband/interleaving/current/{username} | Retrieves the current interleaving option. Only available for users with BT Wholesale products
*BroadbandTroubleshootingApi* | [**broadbandInterleavingPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandinterleavingput) | **PUT** /broadband/interleaving | Updates the interleaving profile. Only available for users with BT Wholesale broadband products
*BroadbandTroubleshootingApi* | [**broadbandPortFlexPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportflexput) | **PUT** /broadband/port/flex | Perform a port flex on a connection
*BroadbandTroubleshootingApi* | [**broadbandPortFlexResultsUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportflexresultsusernameget) | **GET** /broadband/port/flex/results/{username} | Obtain results from the port flex tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandPortFlexResultsUsernameIdGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportflexresultsusernameidget) | **GET** /broadband/port/flex/results/{username}/{id} | Obtain results from the port flex tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandPortRebuildPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportrebuildput) | **PUT** /broadband/port/rebuild | Perform a port rebuild on a connection
*BroadbandTroubleshootingApi* | [**broadbandPortRebuildResultsUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportrebuildresultsusernameget) | **GET** /broadband/port/rebuild/results/{username} | Obtain results from the port rebuild tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandPortRebuildResultsUsernameIdGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportrebuildresultsusernameidget) | **GET** /broadband/port/rebuild/results/{username}/{id} | Obtain results from the port rebuild tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandPortResetPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportresetput) | **PUT** /broadband/port/reset | Perform a port reset on a connection
*BroadbandTroubleshootingApi* | [**broadbandPortResetResultsUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportresetresultsusernameget) | **GET** /broadband/port/reset/results/{username} | Obtain results from the port reset tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandPortResetResultsUsernameIdGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandportresetresultsusernameidget) | **GET** /broadband/port/reset/results/{username}/{id} | Obtain results from the port reset tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandProfileCurrentUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandprofilecurrentusernameget) | **GET** /broadband/profile/current/{username} | Gets the current SNR and interleaving profile. Only available for users with TalkTalk products
*BroadbandTroubleshootingApi* | [**broadbandProfilePut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandprofileput) | **PUT** /broadband/profile | Updates SNR and interleaving profile. Only available for users with TalkTalk products
*BroadbandTroubleshootingApi* | [**broadbandSessionKillPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandsessionkillput) | **PUT** /broadband/session_kill | Perform a session kill on a connection
*BroadbandTroubleshootingApi* | [**broadbandSessionKillResultsUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandsessionkillresultsusernameget) | **GET** /broadband/session_kill/results/{username} | Obtain results from the session kill tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandSessionKillResultsUsernameIdGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandsessionkillresultsusernameidget) | **GET** /broadband/session_kill/results/{username}/{id} | Obtain results from the session kill tool. Returns the latest results, if no ID is specified
*BroadbandTroubleshootingApi* | [**broadbandSnrLogsUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandsnrlogsusernameget) | **GET** /broadband/snr/logs/{username} | Gets SNR logs for a user. Only available for users with BT Wholesale products
*BroadbandTroubleshootingApi* | [**broadbandSnrUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandsnrusernameget) | **GET** /broadband/snr/{username} | Reset the SNR of the user line. Only available for users with BT Wholesale products
*BroadbandTroubleshootingApi* | [**broadbandStabilityCurrentUsernameGet**](docs/Api/BroadbandTroubleshootingApi.md#broadbandstabilitycurrentusernameget) | **GET** /broadband/stability/current/{username} | Gets the current stability option of the line. The stability option will change once the order is complete
*BroadbandTroubleshootingApi* | [**broadbandStabilityPut**](docs/Api/BroadbandTroubleshootingApi.md#broadbandstabilityput) | **PUT** /broadband/stability | Updates the stability of the line
...
*FaxApi* | [**telecomsFaxGetareacodesGet**](docs/Api/FaxApi.md#telecomsfaxgetareacodesget) | **GET** /telecoms/fax/getareacodes | Get Area Codes
*FaxApi* | [**telecomsFaxGetfaxpricesGet**](docs/Api/FaxApi.md#telecomsfaxgetfaxpricesget) | **GET** /telecoms/fax/getfaxprices | Get Fax Prices
...
- [BroadbandCityFibreDetails](docs/Model/BroadbandCityFibreDetails.md)
...
- [BroadbandKBDRadiusLog2](docs/Model/BroadbandKBDRadiusLog2.md)
- [BroadbandKBDRadiusMessage](docs/Model/BroadbandKBDRadiusMessage.md)
- [BroadbandKBDRadiusMessage2](docs/Model/BroadbandKBDRadiusMessage2.md)
...
- [BroadbandSelfServiceRequest](docs/Model/BroadbandSelfServiceRequest.md)
- [BroadbandSelfServiceResponse](docs/Model/BroadbandSelfServiceResponse.md)
- [BroadbandSelfServiceResultsResponse](docs/Model/BroadbandSelfServiceResultsResponse.md)
...
- [BroadbandSpeedTestData](docs/Model/BroadbandSpeedTestData.md)
- [BroadbandSpeedTestDataPoint](docs/Model/BroadbandSpeedTestDataPoint.md)
...
- [InvoiceListResults](docs/Model/InvoiceListResults.md)
- [InvoiceSummary](docs/Model/InvoiceSummary.md)
- [OAuthResponse](docs/Model/OAuthResponse.md)
- [ProblemDetails](docs/Model/ProblemDetails.md)
- [SimwoodPortData](docs/Model/SimwoodPortData.md)
- [SimwoodPortUpdate](docs/Model/SimwoodPortUpdate.md)
- [TelecomsFaxAreaCode](docs/Model/TelecomsFaxAreaCode.md)
- [TelecomsFaxAreaCodeResponse](docs/Model/TelecomsFaxAreaCodeResponse.md)
- [TelecomsFaxPlan](docs/Model/TelecomsFaxPlan.md)
