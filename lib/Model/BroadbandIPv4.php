...
/**
 * BroadbandIPv4 Class Doc Comment
 *
 * @category Class
 ...
 */
class BroadbandIPv4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BroadbandIPv4';
    ...
    */
    ...
    {
        if (is_null($netmask)) {
            array_push($this->openAPINullablesSetToNull, 'netmask');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('netmask', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets range
     *
     * @param int|null $range Number of IP addresses in subnet
     *
     * @return self
     */
     ...
     * Sets usable
     *
     * @param string[]|null $usable Usable IP addresses
     *
     * @return self
     */
    ...
    {
        if (is_null($usable)) {
            array_push($this->openAPINullablesSetToNull, 'usable');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('usable', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets broadcast
     *
     * @param string|null $broadcast Broadcast address
     *
     * @return self
     */
    public function setBroadcast($broadcast)
    {
        if (is_null($broadcast)) {
            array_push($this->openAPINullablesSetToNull, 'broadcast');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('broadcast', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
