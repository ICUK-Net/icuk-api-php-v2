...
class BroadbandOrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ecc', $data ?? [], null);
        $this->setIfExists('trc', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['ecc'];
    }

    /**
     * Sets ecc
     *
     * @param int|null $ecc Engineering Charge Code. Set to -1 for Not Applicable.
     *
     * @return self
     */
    ...
    {
        if (is_null($ecc)) {
            throw new \InvalidArgumentException('non-nullable ecc cannot be null');
        }
        $this->container['ecc'] = $ecc;
    ...
    {
        return $this->container['trc'];
    }

    /**
     * Sets trc
     *
     * @param int|null $trc Time Related Costs. Set to 0 for up to 1-hour and no charge.
     *
     * @return self
     */
    ...
    {
        if (is_null($trc)) {
            throw new \InvalidArgumentException('non-nullable trc cannot be null');
        }
        $this->container['trc'] = $trc;
