...
class InvoiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('item_vat', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $item_unit_price Item Unit Price
     *
     * @return self
     */
    ...
    {
        return $this->container['item_vat'];
    }

    /**
     * Sets item_vat
     *
     * @param float|null $item_vat Item Total VAT
     *
     * @return self
     */
    ...
    {
        if (is_null($item_vat)) {
            throw new \InvalidArgumentException('non-nullable item_vat cannot be null');
        }
        $this->container['item_vat'] = $item_vat;
     ...
     * Sets item_total
     *
     * @param float|null $item_total Item Total
     *
     * @return self
     */
