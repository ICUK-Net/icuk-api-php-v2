...
/**
 * BroadbandIPRDNS Class Doc Comment
 *
 * @category Class
 ...
 */
class BroadbandIPRDNS implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BroadbandIPRDNS';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ptr_record', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets ptr_record
     *
     * @param string|null $ptr_record PTR Record
     *
     * @return self
     */
    public function setPtrRecord($ptr_record)
    {
        if (is_null($ptr_record)) {
            array_push($this->openAPINullablesSetToNull, 'ptr_record');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ptr_record', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
