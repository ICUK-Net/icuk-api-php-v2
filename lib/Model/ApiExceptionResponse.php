...
/**
 * ApiExceptionResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiExceptionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiExceptionResponse';
    ...
    */
     ...
     *
     * @param string|null $exception_message Exception message
     *
     * @return self
     */
    public function setExceptionMessage($exception_message)
    {
        if (is_null($exception_message)) {
            array_push($this->openAPINullablesSetToNull, 'exception_message');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('exception_message', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets exception_type
     *
     * @param string|null $exception_type The exception type
     *
     * @return self
     */
    public function setExceptionType($exception_type)
    {
        if (is_null($exception_type)) {
            array_push($this->openAPINullablesSetToNull, 'exception_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('exception_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
