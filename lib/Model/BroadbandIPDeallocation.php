...
/**
 * BroadbandIPDeallocation Class Doc Comment
 *
 * @category Class
 ...
 */
class BroadbandIPDeallocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BroadbandIPDeallocation';
    ...
    */
    ...
    public function setIp($ip)
    {
        ...
        if ((mb_strlen($ip) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling BroadbandIPDeallocation., must be bigger than or equal to 1.');
        }
