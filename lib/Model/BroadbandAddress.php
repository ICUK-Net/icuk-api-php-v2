...
class BroadbandAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uprn', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $organisation_name Organisation name
     *
     * @return self
     */
    ...
    {
        return $this->container['uprn'];
    }

    /**
     * Sets uprn
     *
     * @param int|null $uprn UPRN. Required for CityFibre checker.
     *
     * @return self
     */
    ...
    {
        if (is_null($uprn)) {
            throw new \InvalidArgumentException('non-nullable uprn cannot be null');
        }
        $this->container['uprn'] = $uprn;
