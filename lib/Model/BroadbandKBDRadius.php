...
class BroadbandKBDRadius implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'log_message2' => '\OpenAPI\Client\Model\BroadbandKBDRadiusMessage2',
        'log_summary2' => '\OpenAPI\Client\Model\BroadbandKBDRadiusLog2[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'log_message2' => 'log_message2',
        'log_summary2' => 'log_summary2'
    ];
    ...
    protected static $setters = [
        ...
        'log_message2' => 'setLogMessage2',
        'log_summary2' => 'setLogSummary2'
    ];
    ...
    protected static $getters = [
        ...
        'log_message2' => 'getLogMessage2',
        'log_summary2' => 'getLogSummary2'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('log_message2', $data ?? [], null);
        $this->setIfExists('log_summary2', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets log_message2
     *
     * @return \OpenAPI\Client\Model\BroadbandKBDRadiusMessage2|null
     */
    public function getLogMessage2()
    {
        return $this->container['log_message2'];
    }

    /**
     * Sets log_message2
     *
     * @param \OpenAPI\Client\Model\BroadbandKBDRadiusMessage2|null $log_message2 log_message2
     *
     * @return self
     */
    public function setLogMessage2($log_message2)
    {
        if (is_null($log_message2)) {
            throw new \InvalidArgumentException('non-nullable log_message2 cannot be null');
        }
        $this->container['log_message2'] = $log_message2;
     ...
     * Gets log_summary2
     *
     * @return \OpenAPI\Client\Model\BroadbandKBDRadiusLog2[]|null
     */
    public function getLogSummary2()
    {
        return $this->container['log_summary2'];
    }

    /**
     * Sets log_summary2
     *
     * @param \OpenAPI\Client\Model\BroadbandKBDRadiusLog2[]|null $log_summary2 BroadbandKBDRadiusLog2 struct
     *
     * @return self
     */
    public function setLogSummary2($log_summary2)
    {
        if (is_null($log_summary2)) {
            array_push($this->openAPINullablesSetToNull, 'log_summary2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('log_summary2', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['log_summary2'] = $log_summary2;
