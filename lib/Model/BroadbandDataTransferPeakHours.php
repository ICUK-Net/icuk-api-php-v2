<?php
/**
 * BroadbandDataTransferPeakHours
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * BroadbandDataTransferPeakHours Class Doc Comment
 *
 * @category Class
 ...
 */
class BroadbandDataTransferPeakHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BroadbandDataTransferPeakHours';
    ...
    */
     ...
     * Sets start
     *
     * @param string|null $start Start time
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string|null $end End time
     *
     * @return self
     */
